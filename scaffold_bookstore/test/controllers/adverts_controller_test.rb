...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { description: @advert.description, email: @advert.email, name: @advert.name, price: @advert.price, seller_id: @advert.seller_id }
    end
  ...
  test "should update advert" do
    patch :update, id: @advert, advert: { description: @advert.description, email: @advert.email, name: @advert.name, price: @advert.price, seller_id: @advert.seller_id }
    assert_redirected_to advert_path(assigns(:advert))
  end
